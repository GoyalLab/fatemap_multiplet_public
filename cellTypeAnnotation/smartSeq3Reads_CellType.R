...
outputDirectory <- "~/Keerthana/CellTypeCountData/smartSeq3Reads/"
outputRDS <- "~/Keerthana/CellTypeCountData/finalRDS/smartSeq3Reads/"
outputDirectoryPlots <- "~/Keerthana/CellTypeCountData/plots/smartSeq3Reads/"
outputDirectoryData <- "~/Keerthana/CellTypeCountData/plotData/UmapData/smartSeqReads/"
...
write_csv(df, paste0(outputDirectoryData, "smartSeq3Reads.csv") )
...
cellTypeAnnotate <- function(sample){
  ...
  SaveSeuratRds(sample, paste0(outputRDS,  "smartSeq3Reads.rds"))
