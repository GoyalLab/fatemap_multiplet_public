...
inputDirectoryPaper = "~/Keerthana/CellCounts/UnprocessedData/FateMap/FM06/"
...
inputDirectorySingletCode = "~/Keerthana/CellCounts/SingletCodeData/FM06/"
...
samples <- c("FM06-WM989Naive-1", "FM06-WM989Naive-2")
...
for (index in 1:length(samples)){
  ...
  print(sampleName)
  countsPaper <- Read10X(data.dir = paste0(inputDirectoryPaper, "10X/", sampleName,"/filtered_feature_bc_matrix"))
  ...
  #Data 8
  numPaperSingletsQC <- append(numPaperSingletsQC, filterQC(samplePaper, featuresLower, featuresUpper, percentMito, save = TRUE, outputPath = paste0(outputRDSPaper, "FateMap_FM06_", sampleName, ".rds")))
  ...
  #Data 10
  numTrueSingletsQC <- append(numTrueSingletsQC, filterQC(sampleSingletCode, featuresLower, featuresUpper, percentMito, save = TRUE, outputPath = paste0(outputRDSSingletCode, "FateMap_FM06_", sampleName, ".rds")))
}
...
write.csv(CellNumbers, paste0(outputNumbers, "FateMap_FM06.csv"))
