...
main<-function (root_dir, METHOD_ID, out_dir){
  ...
  for(cur_bchmk_dataset in all_bchmk_dataset){
    ...
    cur_file <- glue("/projects/b1042/GoyalLab/zzhang/doublet_objects_benchmarking_data_no_mod/hybrid/{cur_data_id}.rds")
    cur_out_df<-run_cxds(sce, exp_dbl=cur_exp_dbl, doublet_obj_file=cur_file)
