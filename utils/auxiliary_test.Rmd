...
cur_data_dir <- "/projects/p31666/zzhang/doublet-bchmk/data/fatemap_data/FM04"
METHOD_ID <- "Doublet_FInder"

run_doublet_finder_on_dataset(cur_data_dir, METHOD_ID)
```
